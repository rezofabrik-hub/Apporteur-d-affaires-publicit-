  ...
  const faqDroit = REG ? [
    {
      ...
      a: REG.grande
        ? variante("faq-totem-oui", [
            ...
            `Oui, et c'est le seuil de population qui l'autorise. Avec ${REG.pop.toLocaleString("fr-FR")} habitants, ${city.name} dépasse les 10 000 de l'article R.581-65 : les enseignes scellées au sol de plus d'un mètre carré y deviennent possibles. Restent trois limites — 6,50 m de haut au-delà d'un mètre de large, 8 m en dessous, et un seul dispositif de plus d'un mètre carré par voie publique bordant l'établissement. Vérifiez ensuite le règlement local, qui peut resserrer chacune d'elles.`,
            `Oui, dans les limites de l'article R.581-65. ${city.name} et ses ${REG.pop.toLocaleString("fr-FR")} habitants sont au-dessus du seuil de 10 000 qui commande cette autorisation. Comptez 6,50 m de hauteur maximale pour un dispositif large d'un mètre ou plus, 8 m pour un dispositif plus étroit, et un seul au-delà d'un mètre carré le long de chaque voie bordant votre établissement. Un règlement local de publicité ne peut qu'ajouter des contraintes.`,
            `Oui. Le texte applicable est l'article R.581-65 du code de l'environnement, et il fait dépendre la réponse d'un seul chiffre : au-dessus de 10 000 habitants, l'enseigne scellée au sol de plus d'un mètre carré est admise. ${city.name} en compte ${REG.pop.toLocaleString("fr-FR")}. Le dispositif ne peut dépasser 6,50 m de haut s'il fait un mètre de large ou plus, 8 m sinon, et il ne peut y en avoir qu'un par voie publique bordant l'établissement.`
          ])
        : variante("faq-totem-non", [
            ...
            `Pas au-delà d'un mètre carré. Avec ${REG.pop.toLocaleString("fr-FR")} habitants, ${city.name} reste sous le seuil de 10 000 de l'article R.581-65, et ce texte n'autorise pas l'enseigne scellée au sol qui dépasse cette surface${REG.uuGrande ? " — l'appartenance à l'unité urbaine de " + REG.uu + " ne change rien, le texte ne regarde que la population de l'agglomération" : ""}. Trois solutions restent ouvertes : l'enseigne de façade, le drapeau en potence, et le dispositif au sol d'un mètre carré au plus.`,
            `Non, et c'est une question de seuil, pas de goût. L'article R.581-65 du code de l'environnement réserve l'enseigne scellée au sol de plus d'un mètre carré aux communes de plus de 10 000 habitants ; ${city.name} en compte ${REG.pop.toLocaleString("fr-FR")}${REG.uuGrande ? ", et son rattachement à l'unité urbaine de " + REG.uu + " est sans effet ici, le texte raisonnant sur la seule agglomération" : ""}. Un totem est donc hors jeu, mais la façade, le drapeau et le petit dispositif au sol ne le sont pas.`,
            `Non au-delà d'un mètre carré, et il vaut mieux le savoir avant de faire chiffrer. ${city.name} compte ${REG.pop.toLocaleString("fr-FR")} habitants, en deçà du seuil de 10 000 posé par l'article R.581-65${REG.uuGrande ? " — notez que l'unité urbaine de " + REG.uu + " n'entre pas en ligne de compte, ce texte ne regarde que la population de l'agglomération" : ""}. L'enseigne de façade et le drapeau en potence restent les deux formats qui portent le plus loin dans ce cas.`
          ])
    },
    {
      q: `Une enseigne ou une publicité lumineuse est-elle autorisée à ${city.name} ?`,
      a: (() => {
        const motif = REG.grande
          ? `Avec ${REG.pop.toLocaleString("fr-FR")} habitants, ${city.name} dépasse le seuil de 10 000`
          : `${city.name} compte ${REG.pop.toLocaleString("fr-FR")} habitants mais appartient à l'unité urbaine de ${REG.uu}, qui dépasse 100 000 habitants`;
        return REG.largePub
          ? variante("faq-lum-oui", [
              `Oui. ${motif} : la publicité lumineuse peut y être autorisée au titre de l'article R.581-34. Elle reste soumise à l'extinction nocturne obligatoire et aux prescriptions d'économie d'énergie. L'enseigne lumineuse obéit quant à elle à l'article R.581-59, avec sa propre obligation d'extinction.`,
              `Oui, mais il faut distinguer les deux. ${motif}, ce qui ouvre la possibilité d'une publicité lumineuse au sens de l'article R.581-34 — sous réserve de l'extinction nocturne et des prescriptions d'économie d'énergie. Votre propre enseigne lumineuse, elle, ne relève pas de ce texte mais de l'article R.581-59, qui a sa propre règle d'extinction.`,
              `Oui pour l'une comme pour l'autre, à des conditions différentes. ${motif} : l'article R.581-34 permet d'y autoriser la publicité lumineuse, avec extinction nocturne et limitation de consommation. L'enseigne lumineuse de votre établissement suit l'article R.581-59 — c'est un régime distinct, qu'on confond souvent avec le premier.`,
              `Oui. Le seuil est franchi — ${motif.toLowerCase()} — et l'article R.581-34 du code de l'environnement autorise dès lors la publicité lumineuse, encadrée par l'extinction nocturne et les prescriptions d'économie d'énergie. Ne confondez pas avec votre enseigne lumineuse, régie par l'article R.581-59 et sa propre obligation d'extinction.`
            ])
          : variante("faq-lum-non", [
              ...
              `Non pour la publicité lumineuse, oui pour votre enseigne. ${city.name} et ses ${REG.pop.toLocaleString("fr-FR")} habitants ne relèvent d'aucune unité urbaine de plus de 100 000 habitants, si bien que l'article R.581-34 ne permet pas d'y autoriser la publicité lumineuse. L'enseigne lumineuse de votre établissement obéit à un autre texte — l'article R.581-59 — et reste possible, extinction nocturne comprise.`,
              `Il faut séparer les deux cas. La publicité lumineuse est écartée : avec ${REG.pop.toLocaleString("fr-FR")} habitants et hors unité urbaine de plus de 100 000, ${city.name} ne remplit pas les conditions de l'article R.581-34. Votre enseigne lumineuse, en revanche, relève de l'article R.581-59 et demeure autorisée, sous réserve de l'extinction nocturne.`,
              `Non, et la raison tient au double seuil de l'article R.581-34 : ni les ${REG.pop.toLocaleString("fr-FR")} habitants de ${city.name}, ni son rattachement urbain n'atteignent les niveaux requis pour y autoriser une publicité lumineuse. Cela ne touche pas votre propre enseigne lumineuse, qui suit l'article R.581-59 et reste possible avec extinction nocturne.`
            ]);
      })()
    },
    {
      ...
      a: (() => {
        const limite = REG.largePub
          ? "10,50 m² de surface unitaire et 7,50 m de hauteur au maximum"
          : "4,70 m² de surface unitaire et 6 m de hauteur au maximum, une surface qu'un arrêté préfectoral peut porter à 8 m² le long d'une route à grande circulation";
        return variante("faq-surface", [
          `Pour une publicité murale non lumineuse, ${limite} (art. R.581-26). Attention au chiffre de 12 m² que l'on lit encore : il a été ramené à 10,50 m² par le décret n° 2023-1007 du 30 octobre 2023. Pour vos enseignes de façade, la règle est ailleurs : leur surface cumulée ne peut dépasser 15 % de la façade commerciale, 25 % si celle-ci mesure moins de 50 m² (art. R.581-63).`,
          `Deux régimes à ne pas mélanger. La publicité murale non lumineuse est plafonnée à ${limite}, au titre de l'article R.581-26 — et si vous lisez encore 12 m² quelque part, la valeur est périmée : le décret n° 2023-1007 du 30 octobre 2023 l'a ramenée à 10,50 m². Vos enseignes de façade relèvent de l'article R.581-63 : cumulées, elles ne peuvent couvrir plus de 15 % de la façade commerciale, ou 25 % si celle-ci fait moins de 50 m².`,
          `Cela dépend de ce qu'on mesure. Une publicité murale non lumineuse est limitée à ${limite} (art. R.581-26) ; le plafond de 12 m² que l'on trouve encore dans de vieux documents a été abaissé à 10,50 m² par le décret n° 2023-1007 du 30 octobre 2023. Pour les enseignes de façade, le calcul est proportionnel et non absolu : 15 % de la surface de façade commerciale, porté à 25 % lorsqu'elle mesure moins de 50 m² (art. R.581-63).`,
          `Il y a une réponse par type de dispositif. Côté publicité murale non lumineuse : ${limite}, selon l'article R.581-26. Le chiffre de 12 m² encore répandu n'a plus cours depuis le décret n° 2023-1007 du 30 octobre 2023, qui l'a ramené à 10,50 m². Côté enseignes de façade, l'article R.581-63 raisonne en pourcentage : 15 % de la façade commerciale au total, 25 % si elle est inférieure à 50 m².`
        ]);
      })()
    }
  ] : [];
