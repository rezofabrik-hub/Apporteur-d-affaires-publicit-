...
<section class="sec bg-2" id="reseau">
  <div class="wrap">
    <div class="sec-head">
    ...
    <div class="grid g-2">
      <article class="card sens-card"><div class="card-body">
        <span class="sens-fleche" aria-hidden="true">&darr;</span>
        <h3>Le client final vient à vous</h3>
        <p>Un commerçant, un restaurateur, un syndic ou une collectivité cherche une enseigne dans
        sa ville. Nous qualifions son projet par téléphone, nous le traduisons en cahier des
        charges, et nous l'adressons à deux ou trois entreprises — jamais davantage.</p>
        <p class="sens-contre">Les places de marché revendent le même contact à cinq ou dix
        entreprises, et prélèvent au passage.</p>
      </div></article>
      <article class="card sens-card"><div class="card-body">
        <span class="sens-fleche" aria-hidden="true">&rarr;</span>
        <h3>Vous cherchez, le réseau répond</h3>
        <p>Un marché gagné à trois cents kilomètres, un traceur en panne un vendredi, une nacelle
        de 22 mètres pour une semaine, un avis technique sur une façade classée : vous le demandez
        au réseau, un confrère répond. C'est compris dans l'abonnement.</p>
        <p class="sens-contre">Les réseaux de sous-traitance de pose prennent une marge sur chaque
        chantier qu'ils vous confient.</p>
      </div></article>
    </div>
    <div class="btns" style="justify-content:center;margin-top:34px">
      <a class="btn btn-pro btn-lg" href="pourquoi-adherer.html">Pourquoi adhérer au réseau</a>
      <a class="btn btn-ghost btn-lg" href="partenaires.html">Formules et tarifs</a>
    </div>
  </div>
</section>
