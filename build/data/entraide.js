...
module.exports = {
  ...
  faq: [
    { q: "Ce service est-il compris dans l'abonnement ?", a: "Oui, dans les trois formules, sans supplément. C'est même la raison pour laquelle elle existe : un réseau qui démarre met six à douze mois à produire un flux de demandes clients régulier, et il serait malhonnête de faire payer une année pour une promesse qui ne se réalisera qu'au printemps suivant. L'entraide, elle, fonctionne dès la première semaine." },
