...
TOPICS = {
    ...
    "imprimerie":         (["offset printing press", "heidelberg printing press", "print shop workshop",
                            "printing plant machine", "business cards printing", "print finishing bindery",
                            "letterpress printing", "graphic arts printing workshop"],
                           ["Offset printing", "Printing presses", "Offset printing presses",
                            "Printing machines", "Printing industry"]),
    "impression-3d":      (["3d printer printing", "3d printing filament", "fdm 3d printer",
                            "resin 3d printer", "3d printed parts", "3d printing prototype"],
                           ["3D printers", "3D printing", "Fused filament fabrication"]),
    "site-internet":      (["web design workspace", "responsive website mockup", "laptop website design",
                            "web developer coding screen", "website wireframe sketch",
                            "designer laptop desk website"],
                           ["Web design", "Website screenshots", "Responsive web design"]),
    "referencement":      (["web analytics dashboard", "analytics graph screen", "seo marketing analysis",
                            "statistics dashboard laptop", "digital marketing meeting",
